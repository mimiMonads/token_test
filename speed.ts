import verifier from "https://deno.land/x/endofunctor/components/tokens/verifier.ts";
...
Deno.bench("genericSigner_8_4", () => genericSigner_4(token_8))
Deno.bench("genericSigner_16_4", () => genericSigner_4(token_16))
Deno.bench("genericSigner_24_4", () => genericSigner_4(token_24))
Deno.bench("genericSigner_32_4", () => genericSigner_4(token_32))
Deno.bench("genericSigner_40_4", () => genericSigner_4(token_40))

Deno.bench("genericSigner_8_1", () => genericSigner_1(token_8))
Deno.bench("genericSigner_16_1", () => genericSigner_1(token_16))
Deno.bench("genericSigner_24_1", () => genericSigner_1(token_24))
Deno.bench("genericSigner_32_1", () => genericSigner_1(token_32))
Deno.bench("genericSigner_40_1", () => genericSigner_1(token_40))

Deno.bench("Sign_8_4", () => sign_8(token_8))
Deno.bench("Sign_16_4", () => sign_16(token_16))
Deno.bench("Sign_24_4", () => sign_24(token_24))
Deno.bench("Sign_32_4", () => sign_32(token_32))
Deno.bench("Sign_40_4", () => sign_40(token_40))


Deno.bench("Sign_8_1", () => sign_8_1(token_8))
Deno.bench("Sign_16_1", () => sign_16_1(token_16))
Deno.bench("Sign_24_1", () => sign_24_1(token_24))
Deno.bench("Sign_32_1", () => sign_32_1(token_32))
Deno.bench("Sign_40_1", () => sign_40_1(token_40))

Deno.bench("Sha256Signer_8", () => { signWithSha(token_8) })
Deno.bench("Sha256Signer_16", () => { signWithSha(token_16) })
Deno.bench("Sha256Signer_24", () => { signWithSha(token_24) })
Deno.bench("Sha256Signer_32", () => { signWithSha(token_32) })
Deno.bench("Sha256Signer_40", () => { signWithSha(token_40) })


Deno.bench("genericVerifier_4_8", () => genericVerifier(signed_token_4_8))
Deno.bench("genericVerifier_4_16", () => genericVerifier(signed_token_4_16))
Deno.bench("genericVerifier_4_24", () => genericVerifier(signed_token_4_24))
Deno.bench("genericVerifier_4_32", () => genericVerifier(signed_token_4_32))
Deno.bench("genericVerifier_4_40", () => genericVerifier(signed_token_4_40))

Deno.bench("genericVerifier_1_8", () => genericVerifier_1(signed_token_1_8))
Deno.bench("genericVerifier_1_16", () => genericVerifier_1(signed_token_1_16))
Deno.bench("genericVerifier_1_24", () => genericVerifier_1(signed_token_1_24))
Deno.bench("genericVerifier_1_32", () => genericVerifier_1(signed_token_1_32))
Deno.bench("genericVerifier_1_40", () => genericVerifier_1(signed_token_1_40))

Deno.bench("verify_8_4", () => verify_8(signed_token_4_8))
Deno.bench("verify_16_4", () => verify_16(signed_token_4_16))
Deno.bench("verify_24_4", () => verify_24(signed_token_4_24))
Deno.bench("verify_32_4", () => verify_32(signed_token_4_32))
Deno.bench("verify_40_4", () => verify_40(signed_token_4_40))

Deno.bench("verify_8_1", () => verify_8_1(signed_token_1_8))
Deno.bench("verify_16_1", () => verify_16_1(signed_token_1_16))
Deno.bench("verify_24_1", () => verify_24_1(signed_token_1_24))
Deno.bench("verify_32_1", () => verify_32_1(signed_token_1_32))
Deno.bench("verify_40_1", () => verify_40_1(signed_token_1_40))

Deno.bench("Sha256Verifier_8", () => { verifyWithSha(signed_token_sha_8) })
Deno.bench("Sha256Verifier_16", () => { verifyWithSha(signed_token_sha_16) })
Deno.bench("Sha256Verifier_24", () => { verifyWithSha(signed_token_sha_24) })
Deno.bench("Sha256Verifier_32", () => { verifyWithSha(signed_token_sha_32) })
Deno.bench("Sha256Verifier_40", () => { verifyWithSha(signed_token_sha_40) })
let i = 0;
